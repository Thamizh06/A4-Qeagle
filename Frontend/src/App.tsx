          ...
          {!results ? (
            <div className="space-y-8">
              <div className="text-center mb-12">
                <div className="p-6 bg-primary rounded-full w-24 h-24 mx-auto mb-6 flex items-center justify-center shadow-lg">
              ...
              {error && (
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-6 flex items-start gap-3 shadow-sm">
