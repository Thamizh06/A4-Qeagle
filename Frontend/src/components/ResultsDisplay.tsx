...
export const ResultsDisplay: React.FC<ResultsDisplayProps> = ({ results, request, onStartOver }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-primary-600 via-primary-700 to-primary-800 text-white rounded-2xl p-8 shadow-purple-lg">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-primary-100 text-sm mt-2 max-w-2xl">{results.notes}</p>
          </div>
